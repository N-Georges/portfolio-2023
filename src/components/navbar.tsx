  ...
  return (
    <div className="navbar flex justify-between fixed inset-x-0 top-0 flex-row z-50  bg-transparent">
      ...
      <div className="navbar-center gap-5">
        ...
        <nav
          className="flex items-center flex-1 justify-center text-center"
          aria-label="Global"
        >
            ...
            {navigation.map((item) => (
              ...
              >
                <span
                  ...
                  } bg-gradient-to-r from-black to-black bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out`}
                >
                  {item.name}
                </span>
              </a>
            ...
            {navigation.map((item) => (
              <li key={item.name}>
                <Link
                  href={item.href}
                  className={` ${
                    currentRoute === item.href && "bg-blue-400 text-white"
                  }`}
                >
